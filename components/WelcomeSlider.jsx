...
import Slider from "react-slick"; // Import a slider package or custom slider
...
const WelcomeSlider = ({ onComplete }) => {
  ...
  return (
    <div className="welcome-slider">
      ...
      <button onClick={onComplete}>Claim Welcome Points</button>
    </div>
  );
};
  ...
  useEffect(() => {
    ...
    fetch("/api/user")
      ...
      .then((data) => {
        setUser(data);
        if (data.isNewUser) {
          setShowSlider(true); // Show slider if user is new
        }
      });
  }, []);
  ...
  return (
    <main>
      {showSlider ? (
        ...
        <div>
          <h3>{user?.points.toLocaleString()} COCKS</h3>
          <>
            <main className="p-3">
                ...
                <section className="w-full p-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mb-2">
                        Complete the task to earn 200 points.
                      </p>
                      <a
