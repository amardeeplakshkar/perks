...
const TaskCard = () =>
{
  ...
  return (
    <div className="w-full p-2 mx-auto overflow-y-scroll rounded-lg shadow-md">
      <h2 className="flex items-center my-2 mb-4 text-xl font-semibold text-white">
        Daily Tasks
        <img
      ...
      <div className="flex items-center justify-between p-3 mb-2 rounded-lg bg-slate-100/15">
        <div className="flex items-center gap-2">
          <div className="flex items-center justify-center w-8 h-8 rounded-full bg-zinc-900">
            <Image src="https://res.cloudinary.com/duscymcfc/image/upload/f_auto,q_auto/v1/Cocks/ton-logo" alt=" TON Logo" width={30} height={30} priority />
          </div>
          <div>
            <div className="text-sm font-semibold text-white">Make Ton Transaction</div>
      ...
      <h2 className="my-2 mb-4 text-xl font-semibold text-white">
      ...
      <div className="pb-16 overflow-scroll max-h-[70dvh] w-full space-y-2">
        {tasks.map((task) => (
          <div
            key={task.id}
            className="flex items-center justify-between p-3 rounded-lg bg-slate-100/15"
          >
            <div className="flex items-center gap-2">
              <div className="p-2 rounded-full bg-zinc-900">{task.icon}</div>
              <div>
